                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="ad_evaluation.php" method="post">
                                            <input type="hidden" name="edit_id" value="<?= $evaluation['id'] ?>">

                                            <div class="form-group">
                                                <label for="task_name">Task:</label>
                                                <input type="text" name="task_name" value="<?= $evaluation['task_name'] ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="name">Name:</label>
                                                <input type="text" name="name" value="<?= $evaluation['name'] ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="evaluator">Evaluator:</label>
                                                <input type="text" name="evaluator" value="<?= $evaluation['evaluator'] ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="performance_average">Performance Average:</label>
                                                <input type="number" name="performance_average" value="<?= $evaluation['performance_average'] ?>" required>
                                            </div>
